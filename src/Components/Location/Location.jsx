const Location = () => {
    return (
        <div className="w-full pb-10 bg-black">
            <h2 className="text-white text-4xl font-bold font-courier pt-10 pr-8 pb-10 pl-[30px] md:pl-[180px]">{`Our Location`}</h2>
            <div className="w-10/12 mx-auto">
                <iframe
                    ...
                    className="w-full h-80 border-none filter invert-[90%] brightness-90 contrast-120"
                    allowFullScreen=""
                    loading="lazy"
                ></iframe>
            </div>
