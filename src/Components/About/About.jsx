...
export const About = () => {
  ...
  <div className="w-full flex flex-col items-center">
    ...
    <div className="flex flex-col md:flex-row items-center w-full" style={{ marginTop: '-200px' }}> 
      ...
      <div className="w-full md:w-1/2 text-left p-0 md:pl-0" style={{ marginTop: '-50px', marginLeft: '-300px' }}>
    ...
    <div className="flex flex-col md:flex-row items-center w-full" style={{ marginTop: '-550px' , marginBottom:'-200px'}}>
      <div className="w-full md:w-1/2 text-left p-4" style={{  marginLeft: '360px' }}>
...
<section className="inset-0 bg-gradient-to from-black via-transparent mb-16 mt-16">
  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-0 gap-y-20 px-12 max-w-7xl w-full ml-[18%]">
